...
- Nominations for MSCS Student Advisory Board due this Friday!
- If you turned in TT1, feedback is in spreadsheet. 
...
> **Implication**: [Visualizations](https://www.forbes.com/sites/forbescommunicationscouncil/2022/02/15/understanding-the-role-of-memory-in-effective-data-visualization/?sh=4905de4261e7) must serve as external aids to augment working memory. If a visualization is unfamiliar, then it won't be as aeffective.
...
- Work on finishing Assignment 2 (due Tuesday)
- Check out optional readings!
- FYC: Check out Library Sessions assignment due Friday!
