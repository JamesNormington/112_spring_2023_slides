...
Put all of the files in one folder. Open the Rmd and the bib files in RStudio. 
...
1. You write a one sentence summary about one of your articles you found.
...
3. Note the label: \@type{label,...  In your one sentence summary, use the syntax in the examples above where the labels were heggeseth2013 and heggeseth2019 to cite YOUR article using YOUR label. 
