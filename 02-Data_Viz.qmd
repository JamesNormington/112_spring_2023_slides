...
Continue on with the activity working through in the [template Rmd](https://bcheggeseth.github.io/112_fall_2022/template_rmd/02-Intro_Data_Viz.Rmd). 
...
Continue to work through the activity in the template Rmd file. 

You'll submit a knitted html file of that template file for Assignment 2 (due next Tuesday).
